    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 px-[10%]">
      ...
      >
       ...
       <div className="absolute top-[60%] left-[10%] w-[50%] ">
        <div className='font-semibold text-base text-white text-left '>35 NEW ITEMS</div>
        <div className=' text-lg text-white text-left '>Discover the latest trends with our new arrivals</div>
